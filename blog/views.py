...
class BlogPostListView(ListView):
    ...
    model = BlogPost
    template_name = 'blog/templates/blogpost_list.html'
...
class BlogPostDetailView(DetailView):
    ...
    model = BlogPost
    template_name = 'blog/templates/blogpost_detail.html'
...
class BlogPostCreateView(CreateView):
    ...
    model = BlogPost
    template_name = 'blog/templates/blogpost_form.html'
...
class BlogPostDeleteView(DeleteView):
    ...
    model = BlogPost
    template_name = 'blog/templates/blogpost_confirm_delete.html'
    success_url = reverse_lazy('blog:post_list')
